                    ...
                    <div class="p-4 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex flex-wrap -mx-3">
                            <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                <h4 class="mb-0  ">Listado de asistencia</h4>
                            </div>
                        </div>
                    </div>
                                        ...
                                        {{-- <form action="" method="POST" novalidate>
                                            ...
                                            <div class="flex flex-wrap -mx-3">
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label for="nombre"
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700  /80">Nombre
                                                            de proveedor</label>
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label for="codigo"
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700  /80">Código</label>
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label for="telefono"
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700  /80">Teléfono</label>
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        <label for="email"
                                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700  /80">Email</label>
                                                ...
                                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        @enderror
                                                        <select
                                                            class="js-example-basic-single focus:shadow-primary-outline dark:bg-slate-850   text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-900 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"
                                                            name="pais" id="pais">
                                                ...
                                                <div class="w-1/2 max-w-full px-3 shrink-0 md:w-full md:flex-0">
                                                    <div class="mb-4">
                                                        ...
                                                        class="focus:shadow-primary-outline dark:bg-slate-850   text-sm leading-5.6 ease block w-full appearance-none rounded-lg 
                                                        ...
                                                        placeholder="Ingrese la descripción del cliente">{{old('descripcion')}} </textarea>
                                                        @error('descripcion')
                                                            <p class="text-red-500  my-2 rounded-lg text-sm p-2 text-center">
                                                                {{ $message }}
                                                            </p>
